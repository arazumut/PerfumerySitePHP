                        ...
                        <div class="uk-width-2-3@m">
                            <div data-uk-scrollspy="target: &gt; *; cls: uk-animation-slide-bottom-small; delay: 500">
                                <article class="article-intro">
                                    <div class="article-intro__image shine"><a href="05_blog-post.php"><img src="assets/img/img-article-intro-1.jpg" alt="img-article"></a></div>
                                    <div class="article-intro__head">
                                        <div class="article-intro__info">
                                            <div class="article-intro__author"><img src="assets/img/img-blog-author.png" alt="blog-author"><a href="05_blog-post.php">Rebicca h. clark</a></div>
                                            <div class="article-intro__date"><i class="icon_calendar"></i><span>31 jan 2021</span></div>
                                            <div class="article-intro__category"><i class="icon_ribbon_alt"></i><a href="05_blog-post.php">Makeup</a></div>
                                        </div>
                                ...
                                <article class="article-intro">
                                    <div class="article-intro__image shine">
                                        <div class="video" data-uk-lightbox="video-autoplay:true; index: 1"><a href="https://youtu.be/IUYs3mYgEPI" data-attrs="width: 1280; height: 720;" data-caption="YouTube"><img src="assets/img/img-article-intro-2.jpg" alt="img-article"></a></div>
                                    </div>
                                    <div class="article-intro__head">
                                        <div class="article-intro__info">
                                            <div class="article-intro__author"><img src="assets/img/img-blog-author.png" alt="blog-author"><a href="05_blog-post.php">Ben Jason</a></div>
                                            <div class="article-intro__date"><i class="icon_calendar"></i><span>31 jan 2021</span></div>
                                            <div class="article-intro__category"><i class="icon_ribbon_alt"></i><a href="05_blog-post.php">Fitness</a></div>
                                        </div>
                                ...
                                <article class="article-intro">
                                    <div class="article-intro__image shine">
                                        <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" data-uk-slideshow>
                                            <ul class="uk-slideshow-items">
                                                <li><img src="assets/img/img-article-intro-4.jpg" alt data-uk-cover></li>
                                    ...
                                    <div class="article-intro__head">
                                        <div class="article-intro__info">
                                            <div class="article-intro__author"><img src="assets/img/img-blog-author.png" alt="blog-author"><a href="05_blog-post.php">Ben Jason</a></div>
                                            <div class="article-intro__date"><i class="icon_calendar"></i><span>31 jan 2021</span></div>
                                            <div class="article-intro__category"><i class="icon_ribbon_alt"></i><a href="05_blog-post.php">Health</a></div>
                                        </div>
                                ...
                                <article class="article-intro">
                                    <div class="article-intro__image shine"><a href="https://pro-theme.com/page-blog-article.php"><img src="assets/img/img-article-intro-3.jpg" alt="img-article"></a></div>
                                    <div class="article-intro__head">
                                        <div class="article-intro__info">
                                            <div class="article-intro__author"><img src="assets/img/img-blog-author.png" alt="blog-author"><a href="05_blog-post.php">Ben Jason</a></div>
                                            <div class="article-intro__date"><i class="icon_calendar"></i><span>31 jan 2021</span></div>
                            ...
                            <aside class="sidebar">
                                ...
                                <div class="widjet widjet-category">
                                    ...
                                    <ul class="list-category">
                                        <li> <a href="04_blog-main.php"><span>Skin Care</span><span>(45)</span></a></li>
                                        <li class="uk-active"><a href="04_blog-main.php"><span>Eye Brows</span><span>(9)</span></a></li>
                                        <li> <a href="04_blog-main.php"><span>Face Cosmetics</span><span>(128)</span></a></li>
                                        <li> <a href="04_blog-main.php"><span>Hair Care</span><span>(67)</span></a></li>
                                        <li> <a href="04_blog-main.php"><span>Makeup</span><span>(42)</span></a></li>
                                    </ul>
                                </div>
                                <div class="widjet widjet-list-articles">
                                    <h4 class="widjet__title">Recent Posts</h4>
                                    <ul class="list-articles">
                                        <li class="list-articles-item"><a class="list-articles-item__link" href="05_blog-post.php">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card__box">
                                            ...
                                            <div class="product-card__info">
                                                <div class="product-card__title"> <a href="03_product.php">V-Beauty Pack</a><span>Face Lotion</span></div>
